...
const OutgoingInvoice = () => {
  ...
  const generateExcel = () => {
    ...
    XLSX.writeFile(wb, "EConiaSoft e-invoice.xlsx");
  };
  ...
  const exportJsonToPdf = () => {
    ...
    doc.save('EConiaSoft e-invoice.pdf');
  };
  ...
  return (
    <>
      ...
      <XMLComponent 
          ...
          title={t("description.invoices.E_Invoice_XML")}
      ...
      <h2 className="font-bold text-sm mb-2">{t("description.dashboard.OUTGOING_INVOICE_RECEIPT")}</h2>

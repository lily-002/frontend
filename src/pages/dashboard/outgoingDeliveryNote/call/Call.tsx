...
//   }
  ...
  return (
    <>
      ...
      <h2 className="font-bold text-sm mb-2"> DESPATCHES SENT (CALL )</h2>
      ...
      <div className="w-full border border-[#D9D9D9] rounded-md p-4 text-xs mb-4">
        ...
        <div className="flex justify-start items-center gap-4 flex-wrap mb-3">
          <div className="flex justify-start items-center gap-1">
            <input type="radio" name="cancelledStatus" id="cancelled"
              className="w-[13px] h-[13px] accent-primary"
            />
          ...
          <div className="flex justify-start items-center gap-1">
            <input type="radio" name="cancelledStatus" id="notCancelled"
              className="w-[13px] h-[13px] accent-primary"
            />
          ...
          <div className="flex justify-start items-center gap-1">
            <input type="radio" name="cancelledStatus" id="all"
              className="w-[13px] h-[13px] accent-primary"
            />
            <label htmlFor="all">All</label>
          </div>
          ...
          <table className="w-full table-auto text-xs mb-3">
            <thead className="whitespace-nowrap">
              <tr className="bg-[#F3FAFF]">
                ...
                <th className="p-3 text-start border border-primary">Sender Company Mail Box</th>

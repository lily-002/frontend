...
import { removeDeliveryNote } from "../../../../store/features/OutgoingDelivery";
...
const Outgoing = () => {
  ...
  const generateExcel = () => {
    ...
    XLSX.writeFile(wb, "EConiaSoft delivery-note.xlsx");
  };
  ...
  const exportJsonToPdf = () => {
    ...
    doc.save('EConiaSoft delivery-note.pdf');
  };
  ...
  return (
    <>
      ...
      <XMLComponent 
          ...
          title={t("description.invoices.E_Delivery_Outgoing_XML")}
      ...
      <h2 className="font-bold text-sm mb-2">{t("description.dashboard.SENT_DESPATCH_SENT_TO_BE_SENT")}</h2>
            ...
            <>
                ...
                <div className="flex justify-start items-center gap-4 flex-wrap mb-3">
                  ...
                  <div className="flex justify-start items-center gap-1">
                    <input type="radio" name="status" id="waitingResponse"
                      className="w-[13px] h-[13px] accent-primary"
                    />
                    <label htmlFor="waitingResponse">{t("description.dashboard.waiting_response")}</label>
                  </div>
              ...
              {/* <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 text-xs mb-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 lg:col-span-2 xl:col-span-3">
                  ...
                  <input type="date" name="dispatchStartDate"
                    className="border border-[#D9D9D9] rounded outline-primary transition-all p-2"
                  />

                  <input type="date" name="dispatchEndDate"
                    className="border border-[#D9D9D9] rounded outline-primary transition-all p-2"
                  />
                  ...
                  />
                    ...
                    <input type="date" name="creationStartDate"
                        className="border border-[#D9D9D9] rounded outline-primary transition-all p-2"
                    />

                    <input type="date" name="creationEndDate"
                        className="border border-[#D9D9D9] rounded outline-primary transition-all p-2"
                    />
                    ...
                    <input type="text" name="buyerLabel"
                        className="border border-[#D9D9D9] rounded outline-primary transition-all p-2"

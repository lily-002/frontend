...
const IncomingDeliveryCall = () => {
  ...
  return (
    <>
      ...
      <h2 className="font-bold text-sm mb-2">INCOMING DESPATCH CALL</h2>
      <p className="text-xs mb-4">Incoming Delivery Note</p>
      ...
      <div className="w-full border border-[#D9D9D9] rounded-md p-4 text-xs mb-4">
        <div className="flex justify-start items-center gap-4 flex-wrap mb-3">
          <div className="flex justify-start items-center gap-1">
            <input type="radio" name="status" id="cancelled"
          ...
          <div className="flex justify-start items-center gap-1">
            <input type="radio" name="status" id="notCancelled"
              className="w-[13px] h-[13px] accent-primary"
            />
            <label htmlFor="notCancelled">Not Cancelled</label>
          </div>
          ...
          <table className="w-full table-auto text-xs mb-3">
            <thead className="whitespace-nowrap">
              <tr className="bg-[#F3FAFF]">
                ...
                <th className="p-3 text-start border border-primary">Buyer Company</th>
                <th className="p-3 text-start border border-primary">GIB Despatch Type</th>
                <th className="p-3 text-start border border-primary">Buyer Company Vkn</th>
                <th className="p-3 text-start border border-primary">Recipient Company Mailbox</th>
                ...
                <th className="p-3 text-start border border-primary">Despatch Date</th>
                <th className="p-3 text-start border border-primary">Despatch ID</th>
                ...
                <th className="p-3 text-start border border-primary">Active?</th>
                <th className="p-3 text-start border border-primary">Archive?</th>
            ...
            <tbody className="whitespace-nowrap">
              {
                itemsIDs.map(num => (
                  <tr key={num}>
                      ...
                      <td className={`p-3 border border-[#D9D9D9] ${Number.isInteger(+num/2) ? "bg-[#FBFBFB]" : ""}`}>Buyer</td>
                      <td className={`p-3 border border-[#D9D9D9] ${Number.isInteger(+num/2) ? "bg-[#FBFBFB]" : ""}`}>Recipient</td>
                      ...
                      <td className={`p-3 border border-[#D9D9D9] ${Number.isInteger(+num/2) ? "bg-[#FBFBFB]" : ""}`}>Active</td>
                      <td className={`p-3 border border-[#D9D9D9] ${Number.isInteger(+num/2) ? "bg-[#FBFBFB]" : ""}`}>Archive</td>
...
export default IncomingDeliveryCall;
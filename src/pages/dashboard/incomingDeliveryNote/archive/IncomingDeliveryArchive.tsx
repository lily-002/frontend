...
const IncomingDeliveryArchive = () => {
  ...
  const onTakeFromArchive = () => {
    ...
    setArchiveInfo({...archiveInfo, message: "The delivery notes from the archive that you have chosen will be delivered to your inbox. Are you sure?", show: true});
  }
  ...
  return (
    <>
      ...
      <h2 className="font-bold text-sm mb-2">INCOMING DESPATCH ARCHIVE</h2>
      ...
      <div className="w-full min-h-[200px] bg-white text-[#333333] border shadow-md p-3">
        ...
        <div className="flex justify-between items-center gap-4 flex-wrap mb-5">
          ...
          <div className="flex justify-start items-center gap-2 flex-wrap text-xs">
            ...
            <button onClick={onTakeFromArchive} className="rounded-lg bg-primary text-white py-1 px-3">Take from Archive</button>
          </div>
        </div>
...
export default IncomingDeliveryArchive;
...
const ProducerReceiptCancellations = () => {
  ...
  return (
    <>
      <h2 className="font-bold text-sm mb-2">OUTGOING PRODUCER RECEIPT CANCELLATIONS</h2>
      ...
      <div className="w-full min-h-[200px] bg-white text-[#333333] border shadow-md p-3">
        ...
        <div className="flex justify-between items-center gap-4 flex-wrap mb-5">
          ...
          <div className="flex justify-start items-center gap-2 flex-wrap text-xs">
            ...
            <button className="rounded-lg bg-primary text-white py-1 px-3">Restored Cancelled</button>
          </div>
        </div>
            ...
            <tbody className="whitespace-nowrap">
              {
                itemsIDs.map(num => (
                  <tr key={num}>
                      ...
                      <td className={`p-3 border border-[#D9D9D9] ${Number.isInteger(+num/2) ? "bg-[#FBFBFB]" : ""}`}>Last update</td>
                      <td className={`p-3 border border-[#D9D9D9] ${Number.isInteger(+num/2) ? "bg-[#FBFBFB]" : ""}`}>
...
export default ProducerReceiptCancellations;
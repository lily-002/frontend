...
const ProducerReceiptArchive = () => {
  ...
  return (
    <>
      ...
      <h2 className="font-bold text-sm mb-2">OUTGOING PRODUCER RECEIPT ARCHIVE</h2>
          ...
          <table className="w-full table-auto text-xs mb-3">
            <thead className="whitespace-nowrap">
              <tr className="bg-[#F3FAFF]">
                ...
                <th className="p-3 text-start border border-primary">Producer Receipt Date</th>
...
export default ProducerReceiptArchive;
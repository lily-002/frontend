...
interface EditProducerNumberProps {
  show: boolean;
  closeModal: () => void;
}
const EditProducerSerialNumber = ({
  show,
  closeModal,
}: EditProducerNumberProps) => {
        ...
        <div className="bg-white text-xs max-w-sm  shadow-xl w-[500px] h-screen  overflow-y-scroll absolute top-0 right-0 ">
          ...
          <form action="" className="py-4 px-4">
            <h4 className=" text-primary font-normal xm leading-7 form-Header">
              Producer SERIAL NUMBER INFORMATION
            </h4>
            ...
            <div>
              <button className="addUser xs p-2">Save</button>
            </div>
          </form>
        </div>
        {/* form end */}
...
export default EditProducerSerialNumber;

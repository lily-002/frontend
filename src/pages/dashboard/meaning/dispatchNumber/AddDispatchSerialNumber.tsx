...
interface addSerialNumberProps {
    show: boolean;
    closeModal: () => void;
  }
const AddDispatchSerialNumber = (
    {
        show,
        closeModal,
      }: addSerialNumberProps
) => {
        ...
        <div className="bg-white text-xs  max-w-sm   shadow-xl w-[500px] h-screen  overflow-y-scroll absolute top-0 right-0 ">
          <div className="Header flex justify-between items-center gap-3 py-4 px-4">
            <div className="flex justify-start items-center gap-2 ">
              ...
              Add New Despatch Serial Number
              </p>
            </div>
            <div>
          ...
          <form action="" className="py-4 px-4">
            ...
            DESPATCH SERIAL NUMBER INFORMATION
            </h4>
            ...
            <div className="form body p-2">
              ...
              <div className="flex justify-between items-center gap-2 capitalize">
                ...
                <div className="mb-3">
                  <label htmlFor="Despatch send type" className="font-bold text-black p-2">
                    Despatch Send Type
                    <span className="text-red-500 font-light sm whitespace-normal ">
                      *
                    </span>
              ...
              <div className="flex justify-between items-center gap-1 capitalize">
                <div className="mb-3">
                  <label htmlFor="file" className="font-bold  text-black text-xs text-nowrap p-2">
                    E-Archive XSL File:
                  </label>
                  <input
                    type="file"
                ...
                <div className="mb-3">
                  ...
                  >
                    <span className="text-red-500 font-bold whitespace-normal text-nowrap text-xs">
                    There is no e-delivery note XSLT ...
                    </span>
                  </label>
                  <input
                    type="text"
...
export default AddDispatchSerialNumber;
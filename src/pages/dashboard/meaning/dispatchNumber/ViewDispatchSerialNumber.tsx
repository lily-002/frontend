...
interface ViewDispatchSerialNumberProps {
  show: boolean;
  closeModal: () => void;
}
const ViewDispatchSerialNumber = ({
  show,
  closeModal,
}: ViewDispatchSerialNumberProps) => {
      ...
      >
        ...
        <div className="bg-white text-xs  max-w-sm   shadow-xl w-[500px] h-screen  overflow-y-scroll absolute top-0 right-0 ">
          ...
          <form action="" className="py-4 px-4">
            ...
            <div>
              <button className=" bg-[#F16623] text-xs ml-3  text-white rounded-full text-center py-2 px-4 mt-5 xs p-2">
                close
              </button>
            </div>
          </form>
...
export default ViewDispatchSerialNumber;
